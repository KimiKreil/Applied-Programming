...
// A is the coefficient matrix, b is the dependent variable values, x is the solution vector and n is the dimension of A
void guassian_elimination(double **A, double *b , double *x, int n){
